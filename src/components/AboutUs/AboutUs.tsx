    ...
    return (
        <div className={cn(styles['about_us'])}>
            <div className={cn(styles["row_1"])}>
                <AboutUsItem appearance={"small"} type={"image"}
                             image={'https://storage.yandexcloud.net/papalapa-storage/website/mask_group.svg'}/>
                <AboutUsItem appearance={"big"}
                             type={"image"}
                             image={'https://storage.yandexcloud.net/papalapa-storage/website/about_image2.png'}
                />
            ...
            <div className={cn(styles["row_2"])}>
                ...
                />
                <AboutUsItem appearance={"big"} type={"image"}
                             image={'https://storage.yandexcloud.net/papalapa-storage/website/about_image1.png'}/>
            </div>
        </div>
    );
}